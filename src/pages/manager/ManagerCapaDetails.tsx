				...
				<table className="w-full border-collapse border border-slate-655 text-xs bg-white" style={{ tableLayout: 'fixed' }}>
					...
					<thead>
						<tr className="text-center font-bold text-[11px] leading-tight">
							<td className="border border-slate-655 bg-[#1e3a8a] bg-blue-header text-white py-2 w-[18%]" style={{ width: '18%' }}>Part/Product</td>
							<td className="border border-slate-655 bg-[#1e3a8a] bg-blue-header text-white py-2 w-[18%]" style={{ width: '18%' }}>Model Name</td>
							<td className="border border-slate-655 bg-[#1e3a8a] bg-blue-header text-white py-2 w-[18%]" style={{ width: '18%' }}>Customer/Supplier</td>
							<td className="border border-slate-655 bg-[#1e3a8a] bg-blue-header text-white py-2 w-[18%]" style={{ width: '18%' }}>Date</td>
							<td className="border border-slate-655 text-zinc-900 bg-white font-extrabold align-middle w-[10%] px-1" style={{ width: '10%' }} rowSpan={2}>Result</td>
							<td className="border border-slate-655 text-zinc-900 bg-white font-bold py-1 w-[9%]" style={{ width: '9%' }}>OK</td>
							<td className="border border-slate-655 text-zinc-900 bg-white font-bold py-1 w-[9%]" style={{ width: '9%' }}>NG</td>
						</tr>
					...
					<tbody>
						...
						<tr>
							<td className="border border-slate-655 p-2 text-center font-extrabold text-zinc-950 text-xs align-middle">
								{mappedCapa.partName}
							</td>

							<td className="border border-slate-655 p-2.5 align-top space-y-2.5" colSpan={3}>
							...
							<td className="border border-slate-655 p-2.5 align-top space-y-2.5" colSpan={2}>
								<div className="space-y-0.5">
							...
							<td className="border border-slate-655 p-2 text-center font-bold text-zinc-800 text-xs align-middle col-target">
								{mappedCapa.targetDate || mappedCapa.targetedDate}
							</td>

							<td className="border border-slate-655 p-2 text-center font-extrabold text-zinc-950 text-xs align-middle col-status">
